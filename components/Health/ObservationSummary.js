...
class ObservationSummary extends React.Component {
    ...
    render() {
        var values = require('../../db/checkupHistory.json');
            ...
            <ScrollView key = {item.id}>
                <View style = {styles.container1}>
                    <View style={styles.headlineContainer}>
                        <Text style = {styles.headline}>Home / Health / Observation Summary</Text>
                        <Icon name="ellipsis-v" size={20} style={{margin:20}} onPress = {() => this.props.navigation.navigate('RecordObservation')}/>
                    </View>
                ...
                <View style={styles.details}>
                    <View style={styles.details1}>
                        ...
                        <Text onPress = {() => this.props.navigation.navigate('RecordObservation')}>Edit</Text>
                    </View>
...
export default withNavigation(ObservationSummary);